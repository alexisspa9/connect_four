...
RSpec.describe Board do
  ...
  context "#down_left" do
    it "can access squares to the lower left" do
      expect(@board.grid[3][3].down_left).to equal @board.grid[4][2]
    end

    it "can access squares farther to the lower left" do
      expect(@board.grid[2][5].down_left.down_left).to equal @board.grid[4][3]
    end
  end
  ...
  context "#down_right" do
    it "can access squares to the lower right" do
      expect(@board.grid[3][3].down_right).to equal @board.grid[4][4]
    end

    it "can access squares farther to the lower right" do
      expect(@board.grid[2][0].down_right.down_right).to equal @board.grid[4][2]
    end
  end
